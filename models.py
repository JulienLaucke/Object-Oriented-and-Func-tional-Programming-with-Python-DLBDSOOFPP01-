...
class CheckORM(Base):
    ...
    ts: Mapped[datetime] = mapped_column(DateTime, nullable=False)              # when the user checked
    period_start: Mapped[datetime] = mapped_column(DateTime, nullable=False)    # normalized period start
    period_end: Mapped[datetime] = mapped_column(DateTime, nullable=False)      # normalized period end
